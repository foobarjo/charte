# Charte Crécerelles
## Sécurité, autonomie et esprit collectif

### Préambule

La pratique du parapente est une activité individuelle qui comporte des risques.

La sécurité repose avant tout sur la capacité de chaque pilote à évaluer les conditions, à connaître ses limites et à prendre des décisions adaptées à sa pratique.

Lors des événements organisés par le club, cette responsabilité individuelle s'inscrit également dans une démarche collective : préparation des vols, échanges entre pilotes, vigilance mutuelle, partage d'expérience et retour sur les vols réalisés.

La présente charte définit les principes et engagements permettant de favoriser une pratique autonome, responsable et sécurisée au sein des Crécerelles.

Elle précise également les rôles respectifs des participants et des organisateurs lors des événements du club.
...
**Ils ne peuvent toutefois garantir la sécurité de chaque participant ni se substituer à la responsabilité individuelle de chaque pilote.**

---

# 3. Rappel et prérequis
...
Toutefois, le club des Crécerelles n'est pas un club formateur. Les adhérents participant aux événements du club doivent donc disposer au minimum de la qualification requise pour la pratique autonome.

Les adhérents qui souhaitent participer aux événements organisés par le club doivent adopter explicitement la présente charte.

---

# 4. Humilité et remise en question

Chaque pilote s'engage à adopter une attitude d'humilité et de remise en question dans sa pratique.
...
# 5. Écoute, respect et échanges constructifs

Les relations entre les membres du club reposent sur le respect, l'écoute et la bienveillance.

Les échanges concernant la pratique et la sécurité ont pour objectif la compréhension, la progression et la sécurité collective, et non le jugement des personnes.
...
# 6. Droit au renoncement

Aucun pilote ne doit se sentir obligé de voler pour suivre le groupe.

Chaque pilote doit pouvoir décider de ne pas décoller, d'interrompre son vol ou de modifier son projet lorsqu'il estime que les conditions ne correspondent plus à ses capacités, à son état ou à ses objectifs.

Le renoncement à un vol ne constitue ni un échec ni un manque d'engagement vis-à-vis du groupe.

Aucun membre ne doit exercer de pression, directe ou indirecte, sur un autre pilote pour l'inciter à voler.

---

# 7. Préparation, briefing et débriefing

La préparation et le retour d'expérience font partie intégrante des événements organisés par le club.
...
La participation à un briefing ou à un débriefing ne signifie pas nécessairement adopter l'analyse ou la décision d'un autre pilote. Le débat et la contradiction constructive sont encouragés lorsqu'ils contribuent à une meilleure compréhension de la situation.

---

# 8. Responsabilité du pilote

Chaque pilote demeure responsable de ses décisions de vol.
...
Le groupe constitue un support d'échange, d'analyse et de vigilance mutuelle, mais ne remplace pas le jugement et la responsabilité du pilote.

---

# 9. Rôle des organisateurs

Les organisateurs assurent la coordination générale de l'événement.
...
# 10. Moyens collectifs et limites
...
Ils ne constituent pas une surveillance permanente des pilotes et ne garantissent pas la détection ou la prise en charge de tous les incidents ou accidents.

Chaque pilote doit donc conserver une autonomie suffisante et ne doit pas considérer ces dispositifs comme un système de secours.

---

# 11. Respect des gestionnaires de sites

Chaque participant s'engage à respecter les demandes et consignes formulées par les gestionnaires des sites visités.

Il s'engage notamment à accepter les demandes d'arrêt des décollages, les demandes d'atterrissage ou toute autre demande relevant des prérogatives des gestionnaires du site.

Les demandes des gestionnaires de site s'imposent aux participants indépendamment des échanges ou décisions internes au groupe.

---

# 12. Vigilance collective

Lorsqu'un pilote constate la présence d'un parapente au sol sans activité apparente du pilote, il communique sa position au groupe, y compris lorsque le pilote concerné est inconnu.

Les pilotes présents au sol peuvent alors contribuer à la vérification de la situation et, si nécessaire, à la mise en œuvre des actions appropriées.

Cette vigilance constitue une entraide entre pilotes et ne constitue pas un dispositif de surveillance permanente.

---

# 13. Matériel

Chaque pilote déclare disposer d'un matériel adapté à sa pratique et en état de fonctionnement.
...
Le club peut recommander certains moyens techniques destinés à faciliter la localisation ou l'assistance d'un pilote.

---

# 14. Tracking

Les participants utilisent le système de tracking proposé par le club lorsque celui-ci est mis en place pour l'événement.

Les pilotes présents au sol peuvent participer à la surveillance des pilotes encore en vol.

Le tracking et la surveillance constituent des moyens collectifs d'alerte et d'assistance.

Ils ne constituent pas un dispositif permanent garantissant la détection de tout accident ou incident lors des événements organisés par le club.

---

# 15. Participation à la vie collective

Les participants contribuent, dans la mesure de leurs possibilités, au bon déroulement des événements.
...
# 16. Informations concernant les pilotes

Les adhérents participant aux événements s'engagent à répondre aux sollicitations des organisateurs.
...
Les participants utilisent les moyens de communication définis pour chaque événement.
...
# 18. Capacité et sélection des sorties
...
La participation à une sortie n'est donc pas automatiquement acquise à tout adhérent.

Lorsque cela est nécessaire, une appréciation collective des candidatures peut être réalisée avant la sortie.

Cette appréciation porte sur **l'adéquation du pilote avec les caractéristiques de la sortie**, et non sur la valeur ou le niveau général du pilote.

---

# 19. Situations nécessitant une adaptation
...
La gravité, la répétition, le contexte et l'évolution du comportement peuvent être pris en compte.

---

# 20. Accompagnement et plan d'action

Lorsqu'une difficulté nécessite une évolution de la pratique, le club privilégie le dialogue et l'accompagnement du pilote.

Lorsque cela est pertinent, un **plan d'action** peut être défini avec le pilote afin de permettre une évolution et, lorsque les conditions sont réunies, un retour aux sorties du club.

Le plan d'action est adapté à la nature des difficultés identifiées.

### 20.1 Difficultés principalement techniques
...
Lorsque cela apparaît pertinent, un accompagnement extérieur auprès d'un professionnel peut également être proposé.

Le désaccord avec l'analyse ou les recommandations du club **ne constitue pas en lui-même un motif d'exclusion**.

En revanche, le refus systématique de tout échange, de toute remise en question ou de toute évolution d'un comportement identifié comme problématique peut être pris en compte dans l'évaluation de la possibilité de participer aux sorties.

---

# 21. Retour aux sorties

Le retour aux sorties est possible lorsque les conditions ayant conduit à la restriction de participation sont considérées comme suffisamment améliorées.
...
L'objectif de cette démarche est de permettre au pilote de retrouver les conditions nécessaires à une participation aux sorties du club, et non de créer une sanction définitive.

---

# 22. Restriction temporaire de participation

Lorsque les éléments disponibles conduisent le club à considérer que la participation d'un pilote à une sortie présente un risque incompatible avec les objectifs de sécurité de celle-ci, le club peut décider de ne pas autoriser sa participation.
...
Le pilote concerné est informé des raisons de la décision et, lorsque cela est possible, des conditions permettant de réexaminer sa participation à de futures sorties.

Une décision de non-participation à une sortie ne constitue pas nécessairement une sanction. Elle peut résulter de l'inadéquation entre le pilote et les caractéristiques particulières de la sortie.

Les situations graves ou répétées peuvent être examinées par le comité directeur conformément aux statuts et au règlement intérieur du club.

---

# 23. Esprit de la charte

La présente charte repose sur un principe simple :

**la sécurité est une responsabilité individuelle et collective.**

Le club ne peut pas garantir la sécurité de chaque pilote.
...
**Voler ensemble, c'est aussi veiller les uns sur les autres.**

---

# 24. Acceptation

La présente charte est présentée aux participants lors des événements organisés par le club.

Tout participant à une sortie s'engage à en prendre connaissance et à en accepter les principes.

L'acceptation de la présente charte constitue une condition de participation aux événements organisés par les Crécerelles.
